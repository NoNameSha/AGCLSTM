...
class Spatial_Attention_layer(nn.Module):
    ...
    def forward(self,X):
        ...
        X4 = torch.bmm(X3,X2.squeeze(-1).permute(0,2,1))
...
class ChebConv_with_sa(nn.Module):
    def __init__(self, c_in, c_out, K, cheb_polynomials, enable_bias, graph_conv_act_func):
    ...
    def forward(self, X,s_a):
        ...
        #out = torch.FloatTensor(outputs).squeeze(-1)
